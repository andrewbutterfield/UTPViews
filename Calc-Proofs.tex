...
\RLEQNS{
   P &=& I_P \land \bigvee_p (I_p \land S_p)
\\ Q &=& I_Q \land \bigvee_q (I_q \land T_q)
...
\\&& I \land D \land D_1 \land D_2
       \land ( (I_P \land \bigvee_p (I_p \land S_p))\gamma_1
               \seq
               (I_Q \land \bigvee_q (I_q \land T_q))\gamma_2 )
\EQ{substitution,\eref{seq-gnd-distr},\eref{skip-gamma}}
\\&& I \land D \land D_1 \land D_2
       \land ( (I_P\gamma_1 \land \bigvee_p (I_p\gamma_1 \land S_p\gamma_1))
               \seq
               (I_Q\gamma_2 \land \bigvee_q (I_q\gamma_2 \land T_q\gamma_2)) )
\\
\\&& [in|\ell_g|out]
     \land \{in|g|out\}
     \land \{in|\g{:1}|\ell_g\}
