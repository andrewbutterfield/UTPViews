...
An active lifted action atomically modifies the extended state as follows:
\begin{itemize}
  \item It makes the changes to $s$ as determined by its underlying action.
  \item It removes the enabling label for the label-set.
...
one that marks the entry into/start of the construct,
