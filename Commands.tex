...
\\&& \lnot \LS{\ell_g}
           \land \LS{in} \land \ado a \land \LUPD{in}{\ell_g} \lor {}
      & \ltype{\lnot\ell_g,in,\lnot in', \ell'_g}
\\&& \LS{out} \land \Skip \lor {}
     & \ltype{out,out'}
\\&&\lnot \LS{out}
           \land \LS{\ell_g} \land \ado b \land \LUPD{\ell_g}{out}
           & \ltype{\lnot out,\ell_g,\lnot \ell'_g,out'}
\\&& ;
...
\RLEQNS{
   D(L) &\defs&  \LS{L} \land \Skip &\ltype{L,L'}
\\ &=& \LS{L} \land \Skip \land \LSd{L}
\\ A(I,O,as,R,A)  
   &=& \LS{I} \land \lnot\LS{O} \land \ado{as} \land \LUPD{R}{A}
            &\ltype{I,\lnot O,\lnot R', A'}
\\ &=& \LS{I} \land \lnot\LS{O} \land \ado{as} \land \LUPD{R}{A} \land {}
\\ && \lnot\LSd{R,(O\!\setminus\! A)}
      \land
      \LSd{A,(I\!\setminus\! R)}
}
