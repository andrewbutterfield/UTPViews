...
versions of the tool descirbed in \cite{DBLP:conf/utp/Butterfield16}.
...
\\ \catom a \parallel \catom b
   &=&
   \Skip \lor A(in|ii|lg1,lg2)           \lor A(lg1:,lg2:|ii|out)
        \lor A(lg1|a|lg1:)              \lor A(lg2|b|lg2:)
        \lor A(in|a|lg1:,lg2)           \lor A(in|b|lg2:,lg1)
        \lor A(lg1,lg2|ba|lg1:,lg2:) \lor A(lg1,lg2|ab|lg1:,lg2:)
        \lor A(lg2:,lg1|a|out)          \lor A(lg1:,lg2|b|out)
        \lor A(in|ba|lg1:,lg2:)      \lor A(in|ab|lg1:,lg2:)
        \lor A(lg1,lg2|ba|out)       \lor A(lg1,lg2|ab|out)
        \lor A(in|ba|out)            \lor A(in|ab|out)
}
\caption{
  Some Test Calculation Results
  Here $ab$ is short for $a \seq b$, etc.
}
