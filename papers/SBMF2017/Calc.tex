...
motivating the UTP-calculator development \cite{conf/utp/Butterfield16}.
...
What has happenned with this UTP theory of concurrency
...
If we look at $\catom a + \catom b$, we also explcitly
...
we can, for example, compute $(\catom a \cseq \catom b) \parallel \catom c$
